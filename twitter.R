...
searchString1 = '#zestmoney'   # change this to see others eg analytics...
## search for 50 tweets using the #sirmaur hashtag
tweets1 <- search_tweets(q = searchString1, n = 500)
...
tweets1B <- search_tweets(searchString1, n = 500, include_rts = FALSE)
...
#@IIM_Sirmaur
searchString2 = 'chapmanlizzie'   # change this to see others
## search for tweets using the searchString hashtag
tweets2 <- search_tweets(q = searchString2, n = 500, retryonratelimit = T)
# view the first 3 rows of the dataframe
head(tweets2[1:5], n = 3)

searchString3 = 'rush2yyz'  #change it your twitter id
...
rt <- search_tweets( "zestmoney", n = 3000, retryonratelimit = TRUE)
